...
#ifndef YY_YY_SINTATICO_HH_INCLUDED
# define YY_YY_SINTATICO_HH_INCLUDED
// "%code requires" blocks.
#line 9 "analise/sintatico.yy"
  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_declarations = 35,                     // declarations
        S_id_seq = 36,                           // id_seq
        S_command_seq = 37,                      // command_seq
        S_command = 38,                          // command
        S_if_loop = 39,                          // if_loop
        S_exp = 40,                              // exp
        S_fst_exp = 41,                          // fst_exp
        S_sec_exp = 42,                          // sec_exp
        S_thr_exp = 43                           // thr_exp
      };
    };
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::TOK_YYEOF
                   || (token::TOK_YYerror <= tok && tok <= token::TOK_NUMBER)
                   || tok == 60
                   || tok == 62
                   || tok == 61
                   || tok == 45
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_SKIP ()
      {
        return symbol_type (token::TOK_SKIP);
      }
#else
      static
      symbol_type
      ...
      make_FI ()
      {
        return symbol_type (token::TOK_FI);
      }
#else
      static
      symbol_type
      ...
      make_READ ()
      {
        return symbol_type (token::TOK_READ);
      }
#else
      static
      symbol_type
      ...
      make_WRITE ()
      {
        return symbol_type (token::TOK_WRITE);
      }
#else
      static
      symbol_type
      ...
      make_ASSGNOP ()
      {
        return symbol_type (token::TOK_ASSGNOP);
      }
#else
      static
      symbol_type
      ...
      make_NUMBER ()
      {
        return symbol_type (token::TOK_NUMBER);
      }
#else
      static
      symbol_type
...
#line 1628 "sintatico.hh"




#endif // !YY_YY_SINTATICO_HH_INCLUDED
